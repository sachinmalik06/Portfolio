                      ...
                      <SidebarMenuItem>
                        ...
                        >
                          <Link to="/admin" className="flex items-center justify-center gap-3 w-full group-data-[collapsible=icon]:gap-0 group-data-[collapsible=icon]:justify-center">
                            <LayoutDashboard className={`w-4 h-4 shrink-0 transition-all duration-200 ${
                              location.pathname === "/admin"
                ...
                {navGroups.map((group) => {
                  ...
                  return (
                    <SidebarGroup key={group.id} className="px-2">
                      <SidebarGroupLabel 
                        className={`flex items-center justify-between cursor-pointer rounded-md px-3 py-2.5 -mx-2 transition-all duration-200 group select-none group-data-[collapsible=icon]:mt-0 group-data-[collapsible=icon]:opacity-100 group-data-[collapsible=icon]:justify-center group-data-[collapsible=icon]:px-2 ${
                          hasActiveItem 
                              ...
                              return (
                                <SidebarMenuItem key={item.to}>
                                  <SidebarMenuButton 
                                    ...
                                    isActive={isActive}
                                    tooltip={item.label}
                                    className={`pl-8 h-auto py-2.5 rounded-lg transition-all duration-200 ${
                                      isActive 
                                        ? 'bg-sidebar-accent/30 text-foreground font-semibold' 
                                  ...
                                  >
                                    <Link to={item.to} className="flex items-center gap-3 w-full group/item">
                                      <item.icon className={`w-4 h-4 shrink-0 transition-all duration-200 ${
                                        isActive 
                                          ? 'text-foreground scale-110' 
