      ...
      >
        <nav className="max-w-7xl mx-auto flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            ...
            {/* Mobile Menu Button */}
            <motion.button
              className="md:hidden w-11 h-11 flex items-center justify-center text-foreground rounded-lg hover:bg-accent/50 transition-colors"
            ...
            <div className="pt-20 px-6 flex flex-col items-center gap-8">
              {navItems.map((item, index) => (
                <motion.div
                  ...
                  className="text-2xl font-semibold text-foreground hover:text-primary transition-colors cursor-pointer py-2"
                  initial={{ opacity: 0, y: 20 }}
                  animate={{ opacity: 1, y: 0 }}
              ...
              <motion.div
                ...
                className="mt-4 flex items-center gap-2 px-6 py-3 rounded-full bg-primary text-primary-foreground cursor-pointer shadow-lg"
                initial={{ opacity: 0 }}
                animate={{ opacity: 1 }}
